...
describe('Todo list service: ', () => {
  ...
  it('todo list filters by owner', () => {
    ...
    let todoName = 'a';
    expect(todoListService.filterTodos(testTodos, todoName, null, null, null).length).toBe(2);
  });
  ...
  it('todo list filters by owner and status', () => {
    ...
    let todoStatus = true;
    let todoName = 'c';
    expect(todoListService.filterTodos(testTodos, todoName, todoStatus, null, null).length).toBe(1);
  });
